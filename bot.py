...
def recibir_mensaje():
    ...
    if texto.lower() == "/tasa":
        ...
        generar_captura()  # Ejecuta captura_binance.py
...
# ===============================
# Ejecutar captura de Binance de forma segura
# ===============================
def generar_captura():
    # Importa y ejecuta solo cuando se llama
...
def obtener_tasa_binance():
    ...
    payload = {"page":1,"rows":20,"asset":"USDT","fiat":"VES","tradeType":"SELL"}
    ...
    for ad in data["data"]:
        ...
        for m in methods:
            ...
            if any(p in metodo for p in metodos_permitidos):
                return price
    return None
...
def enviar_imagen_whatsapp(numero, imagen, caption):
    ...
    data = {
        ...
        "to":numero,
        "type":"image",
        "image":{"link":f"https://TU_SERVIDOR.com/{imagen}","caption":caption}
    }
